...
def procesar_archivos_desde_entrada(files, indicadores_path: str = "indicadores/indicadores.json") -> str:
    ...
    # Crear ZIP excluyendo carpeta de PDFs
    zip_path = f"{temp_output}.zip"
    shutil.make_archive(base_name=temp_output, format='zip', root_dir=temp_output, base_dir=".", logger=None)

    # Limpiar PDFs antes de devolver ZIP (opcional)
