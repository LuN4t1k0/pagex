...
# TRABAJANDO: FUNCIONA: CONSIDERANDO LA COLUMNA 'DÍAS' Y 'AFP2'
# import pdfplumber
# import pandas as pd
# import re
# import os
...
#                     'Cotización Obligatoria', 'SIS', 'Cotización Voluntaria (APVI)', 'N° Contrato APVI',
#                     'Deposito Convenido', 'Dep. en Cta. Ahorro', 'Remuneración Imponible',
#                     'Cotización Afiliado', 'Cotización Empleador', 'Cod.', 'Fecha Inicio', 'Fecha Término', 'AFP', 'Días', 'AFP2']
...
#                 for row in table:  # Iterar sobre todas las filas de la tabla
#                     # Filtrar filas que tengan datos relevantes y no sean encabezados
#                     if row and len(row) >= len(required_columns) - 3 and not is_header_row(row):
#                         row.append(afp_name)  # Agregar el nombre de la AFP a la fila
...
#                     'Cotización Obligatoria', 'SIS', 'Cotización Voluntaria (APVI)', 'N° Contrato APVI',
#                     'Deposito Convenido', 'Dep. en Cta. Ahorro', 'Remuneración Imponible',
#                     'Cotización Afiliado', 'Cotización Empleador', 'Cod.', 'Fecha Inicio', 'Fecha Término', 'AFP', 'Días', 'AFP2', 'Periodo']
